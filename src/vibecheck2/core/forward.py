...
# (a forward-LiRPA planes propagator lived here briefly -- BUILD-1 of the
# nn4sys-dual campaign. MEASURED on the real family: tightness ~= the
# rad-mode zonotope (identical closing depth d=8) at 10x the cost, because
# the correlated first-order mul above already carries what LiRPA's
# back-substituted factor bounds buy. Removed as unused; recover from
# commit dd87a50 + the measurement notes in the nn4sys memory before ever
# rebuilding it.)
