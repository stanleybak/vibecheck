# Ported verbatim from v1 vibecheck.onnx_loader (standalone vc2): the
# ONNX-graph -> node-dataclass builder consumed by network.from_onnx
# (83% line coverage across the 23-family battery; kept whole -- the
# uncovered branches are op variants other nets exercise).
