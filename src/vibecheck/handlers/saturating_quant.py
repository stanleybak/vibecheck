"""Saturating-quantization twins (standalone vc2 port of v1
vibecheck.saturating_quant, byte-identical math; only the
_load_onnx_model import is redirected to the handler module).
...
def extract_matmul_quant_params(onnx_path):
    ...
    from .quant_surrogate import _load_onnx_model
